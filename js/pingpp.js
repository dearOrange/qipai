...
function(e) {
	...
	return function e(n, t, a) {
		...
		23: [function(e, n, t) {
			...
			PingppSDK.prototype = {
				version: a,
				createPayment: function(e, n, t, a) {
					if ('function' == typeof n && (i.userCallback = n), s.init(e), u.call(s, 'id')) if (u.call(s, 'channel')) {
						...
						} else i.innerCallback('fail', i.error('invalid_charge', 'no_livemode_field'));
						else i.innerCallback('fail', i.error('invalid_credential', 'credential_is_incorrect'));
						else i.innerCallback('fail', i.error('invalid_credential', 'credential_is_undefined'));
						else i.innerCallback('fail', i.error('invalid_charge', 'no_credential'))
					} else i.innerCallback('fail', i.error('invalid_charge', 'no_channel'));
					else i.innerCallback('fail', i.error('invalid_charge', 'no_charge_id'))
				},
				setAPURL: function(e) {
					o.APURL = e
				}
				...
				init: function(e) {
					...
					if ('string' == typeof e) try {
						...
						if (void 0 !== n) {
							...
							} else r.call(n, 'charges') && null != n.charges && (n = n.charges.data[0]);
				...
				r = n.exports = {
					...
					request: function(e, n, t, i, l, o) {
						if ('undefined' != typeof XMLHttpRequest) {
							...
							'POST' === n ? (c.setRequestHeader('Content-type', 'application/json; charset=utf-8'), c.send(JSON.stringify(t))) : c.send(), void 0 === i && (i = function() {}), void 0 === l && (l = function() {}), c.onreadystatechange = function() {
